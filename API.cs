...
namespace hwi_spoofer
{
    public class api
    {
        ...
        /// </summary>
        /// <param name="spoofer hwid">Application Name</param>
        /// <param name="xHY2UEMn3n">Your OwnerID, can be found in your account settings.</param>
        /// <param name="92cade5d119dddf880b44ce9e7b53569840e1c1a8eef3249097974e7003b2404">Application Secret</param>
        ...
        public string expirydaysleft()
        {
            ...
            {
                return Convert.ToString("Lifetime");
